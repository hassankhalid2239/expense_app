                              ...
                              builder: (context, scrollController) {
                                return Container(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemCount: Constants.incomeCategoryIcons.length,
                                    itemBuilder: (context, index) {
                                      return Padding(
                                        padding: const EdgeInsets.symmetric(vertical: 5),
                                        child: ListTile(
                                          onTap: (){
                                            _stateController.incomeCategory.value=Constants.incomeCategoryIcons[index].title;
                                            _categoryController.text=_stateController.incomeCategory.value;
                                            Navigator.pop(context);
                                          },
                                          leading: SvgPicture.asset(Constants.incomeCategoryIcons[index].icon),
                                          title: Text(
                                            Constants.incomeCategoryIcons[index].title,
                                            maxLines: 1,
